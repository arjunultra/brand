...
// Getting Data from brands table in srisw
                    ...
                    if (mysqli_num_rows($result) == !empty($result)) {
                        ...
                        foreach ($allRows as $row) { ?>
                            <tr>
                                ...
                                <td><?php echo $row["rate_range"] ?></td>
                                <td><?php echo $row["selected_rate"] ?></td>
                                <td class='d-flex'> <a target="_blank" class="btn btn-outline-primary w-50 me-2"
                                        href="products-form.php?update_id=<?php echo $row['id']; ?>">UPDATE</a>
                                    <a class="btn btn-danger w-50"
                                        href="products-table.php?delete_id=<?php echo $row['id']; ?>">DELETE</a>
                                </td>
                            </tr>
                        <?php }
                    } else {
